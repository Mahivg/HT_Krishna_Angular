...
export class ProductsComponent implements OnInit {
  ...
  products: Product[] = [
    ...
    new Product("p002", "Sunglass", "Used to carry some books", 799, "", true),
    new Product("p003", "water bottle", "Used to carry some books", 799, "", true),
    new Product("p004", "Smartphone", "Used to carry some books", 799, "", true),
  ];
